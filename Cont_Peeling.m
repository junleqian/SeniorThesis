         ...
         while(intvl>0)
             ...
             if(sm>intvl)
                 ...
                 if(nqt>0)  %% nqt: number of queueing task
                    ...
                    SD(QueTL(AssTID,:))=SD(QueTL(AssTID,:))-1;%% update sever degree.
...
%                 SelecS=randperm(nIdleS,NassT);
 ...
 save(['Peelnewr',num2str(LAM),'m',num2str(m),'dur',num2str(dur),'p',num2str(p),'q',num2str(q),'.mat'],'lambda','QsizeP','dQP','MpP','dMpP','MqP','dMqP','Rnqt');
